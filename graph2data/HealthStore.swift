...
class HealthStore {
    ...
    func requestAuthorization(completion: @escaping (Bool) -> Void) {
        ...
        healthStore.requestAuthorization(toShare: [hrType], read: [hrType]) { (success, error) in
    ...
    func getRequestStatusForAuthorization(completion: @escaping (Bool) -> Void) {
        ...
        healthStore.getRequestStatusForAuthorization(toShare: [hrType], read: [hrType]) { (authorizationRequestStatus, error) in
            var status: String = ""
            if let error = error {
